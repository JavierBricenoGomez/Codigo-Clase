...
public class frmDistrito extends javax.swing.JFrame {
    MySqlDistritoDAO daoDis=new MySqlDistritoDAO();
    ...
    private void initComponents() {
        ...
        tblDistritos = new javax.swing.JTable();
        ...
        tblDistritos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tblDistritos);
    ...
    private javax.swing.JTable tblDistritos;
 ...
 void listado(){
     ...
     while(itr.hasNext()){
         Distrito dis=itr.next();
         modelo.addRow (new Object[]{dis.getCodigo(), dis.getNombre()});
